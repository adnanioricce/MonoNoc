...
using Playground.Games.Physics;
...
namespace Playground.Scenes
{
    public class PhysicsGame : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            //Games.Add(new VelcroDemo(_spriteBatch, Content,Globals.ScreenSizeToVector,Mouse.GetState));
            Games.Add(new JointGame(Content, _spriteBatch));
            Games.ForEach(game => {
                game.LoadContent();
                game.Initialize();
            });
